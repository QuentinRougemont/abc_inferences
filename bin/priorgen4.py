...
if(model=="PAN"):
	...
	if(Nvariation=="hetero"):
		res="N1\tshape1Ne\tshape2Ne\tpropNtrlNe1\n"
if(model=="BOT"):
	if(Nvariation=='homo'):
		res="N1\tTbottleneck\n"
	if(Nvariation=="hetero"):
		res="N1\tTbottleneck\tshape1Ne\tshape2Ne\tpropNtrlNe1\n"
if(model=="BOT2"):
	if(Nvariation=='homo'):
		res="N1\tTbottleneck\tNa\n"
	if(Nvariation=="hetero"):
		res="N1\tTbottleneck\tNa\tshape1Ne\tshape2Ne\tpropNtrlNe1\n"

if(model=="SI"):
	if(Nvariation=="homo"):
		if(bottleneck=="Y"):
			res="N1\tN2\tNa\tTsplit\ttimebottleneck\talphapop1\talphapop2\n"
		if(bottleneck=="N"):
			res="N1\tN2\tNa\tTsplit\n"
	if(Nvariation=="hetero"):
		if(bottleneck=="Y"):
			res="N1\tN2\tNa\tTsplit\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\ttimebottleneck\talphapop1\talphapop2\n"
		if(bottleneck=="N"):
...
if(model=="IM"):
	if(Nvariation=="homo"):
		if(Mvariation=="homo"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tM1\tM2\n"
		if(Mvariation=="hetero"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
	if(Nvariation=="hetero"):
		if(Mvariation=="homo"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
...
if(model=="AM"):
	if(Nvariation=="homo"):
		if(Mvariation=="homo"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTam\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTam\tM1\tM2\n"
		if(Mvariation=="hetero"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTam\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTam\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
	if(Nvariation=="hetero"):
		if(Mvariation=="homo"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTam\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTam\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTam\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
...
if(model=="SC"):
	if(Nvariation=="homo"):
		if(Mvariation=="homo"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTsc\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTsc\tM1\tM2\n"
		if(Mvariation=="hetero"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTsc\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTsc\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
	if(Nvariation=="hetero"):
		if(Mvariation=="homo"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTsc\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTsc\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			if(bottleneck=="Y"):
				res="N1\tN2\tNa\tTsplit\tTsc\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
...
if(model=="PSC"):
	if(Nvariation=="homo"):
		if(Mvariation=="homo"):
			...
			#	res="N1\tN2\tNa\tTsplit\tTsc\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTsc1\tTiso1\tTsc2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			#if(bottleneck=="Y"):
			#	res="N1\tN2\tNa\tTsplit\tTsc\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTsc1\tTiso1\tTsc2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
	if(Nvariation=="hetero"):
		if(Mvariation=="homo"):
			#if(bottleneck=="Y"):
			#	res="N1\tN2\tNa\tTsplit\tTsc\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTsc1\tTiso1\tTsc2\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			#if(bottleneck=="Y"):
			#	res="N1\tN2\tNa\tTsplit\tTsc\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTsc1\tTiso1\tTsc2\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
if(model=="PAM"):
	if(Nvariation=="homo"):
		if(Mvariation=="homo"):
			#if(bottleneck=="Y"):
			#	res="N1\tN2\tNa\tTsplit\tTam\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTam1\tTiso1\tTam2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			#if(bottleneck=="Y"):
			#	res="N1\tN2\tNa\tTsplit\tTam\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
	...
	if(Nvariation=="hetero"):
		if(Mvariation=="homo"):
			...
			#	res="N1\tN2\tNa\tTsplit\tTam\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTam1\tTiso1\tTam2\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			#if(bottleneck=="Y"):
			#	res="N1\tN2\tNa\tTsplit\tTam\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\ttimebottleneck\talphapop1\talphapop2\n"
			if(bottleneck=="N"):
				res="N1\tN2\tNa\tTsplit\tTam1\tTiso1\tTam2\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
...
for i in range(nreps):
	...
	alpha1prior=uniform(alpha1[0], alpha1[1]) # réduction pop 1 (donc si on remonte dans le passé une plus grande diversité) ou augmentation (si < 1)
	alpha2prior=uniform(alpha2[0], alpha2[1]) # réduction pop 2 (donc si on remonte dans le passé une plus grande diversité) ou augmentation (si < 1)
