...
Rscript 00-scripts/utility_scripts/ped2matrix.R "$INPUT_1" "$INPUT_2" #usefull to produce the genotypic matrix
Rscript 00-scripts/utility_scripts/prepare.abc.R genotypic.matrix "$input_folder"
