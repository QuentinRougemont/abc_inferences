...
IM1b=IM.1[c(1:nlinesFul),-c(1:3,12,13,18:25)]
IM2b=IM.2[c(1:nlinesFul),-c(1:3,12,13,18:25)]
IM3b=IM.3[c(1:nlinesFul),-c(1:3,12,13,18:25)]
IM4b=IM.4[c(1:nlinesFul),-c(1:3,12,13,18:25)]
SC1b=SC.1[c(1:nlinesFul),-c(1:3,12,13,18:25)]
SC2b=SC.2[c(1:nlinesFul),-c(1:3,12,13,18:25)]
SC3b=SC.3[c(1:nlinesFul),-c(1:3,12,13,18:25)]
SC4b=SC.4[c(1:nlinesFul),-c(1:3,12,13,18:25)]
AM1b=AM.1[c(1:nlinesFul),-c(1:3,12,13,18:25)]
AM2b=AM.2[c(1:nlinesFul),-c(1:3,12,13,18:25)]
AM3b=AM.3[c(1:nlinesFul),-c(1:3,12,13,18:25)]
AM4b=AM.4[c(1:nlinesFul),-c(1:3,12,13,18:25)]
SI1b=SI.1[c(1:nlinesFul),-c(1:3,12,13,18:25)]
SI3b=SI.3[c(1:nlinesFul),-c(1:3,12,13,18:25)]
