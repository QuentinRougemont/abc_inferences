...
M1 <- matrix(scan("00.data/im.homom.homon.ABC.stat.txt"), byrow=T, nrow=nlinesFul)
...
write.table(newsamp,"results/im1.prior.from.post", quote=F, row.names=F, col.names=F)
